...
//jdbc:sqlserver://t4yuhfsreo6kk.database.windows.net:1433;database=qie;user=student@t4yuhfsreo6kk;password={your_password_here};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;
