// from: https://reginbald.medium.com/media/0a2085cfc85155c894ee1c8767b30917
// article for above: https://maartenbuma.nl/creating-app-registration-with-arm-templates-bicep/

// Prior to running this script, some pre-work needs to be done
// # Resource group for the managed identity
// az group create --name app-reg-automation --location westus # User assigned managed identity
